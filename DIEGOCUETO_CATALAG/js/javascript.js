function guardar(){
    ...
    function tabla (MartilloSencillo, img, $300, $can){
...
function agregar(){
    ...
    document.getElementById("tab").innerHTML += '<tbody><td>'+nuevatabla.img+'</td><td>'+nuevatabla.MartilloSencillo+'</td> <td>'+nuevatabla.$can+'</td> <td>'+nuevatabla.$300+'</td></tbody>';
